...
- **S10 — Rust Reference and standard library.** [Interior mutability](https://doc.rust-lang.org/reference/interior-mutability.html), [UnsafeCell](https://doc.rust-lang.org/std/cell/struct.UnsafeCell.html), [Fn](https://doc.rust-lang.org/std/ops/trait.Fn.html), [undefined behavior](https://doc.rust-lang.org/reference/behavior-considered-undefined.html). These distinguish access/alias safety from effect freedom (RS-002/003/004).
