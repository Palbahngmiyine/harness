...
bad probe_dependency '.units += [{"id":"U2","title":"probe","paths":["src/p"],"test":"true","acceptance_ids":["A1"],"depends_on":[],"probe":true,"model":null,"effort":null}] | .units[0].depends_on=["U2"]' 'invalid unit'
