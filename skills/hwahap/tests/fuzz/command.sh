...
base='codex exec -C .hwahap/wt/P1 -s workspace-write --ignore-user-config -m gpt-5.6-luna -c model_reasoning_effort=high -c model_verbosity=low -c model_reasoning_summary=none -c web_search=disabled --ephemeral --json -o .hwahap/out/P1.last.md'
...
test -z "$(run "$base")"
reordered='codex exec --ephemeral -m gpt-5.6-luna -C .hwahap/wt/P1 -c web_search=disabled -s workspace-write -o .hwahap/out/P1.last.md -c model_reasoning_summary=none --json --ignore-user-config -c model_verbosity=low -c model_reasoning_effort=high'
