...
tests=(brief-usage.sh boundary.sh capture-posttool.sh check.sh coverage-contract.sh deliver.sh e2e.sh gate.sh integrate.sh pretool-posttool.sh prompt.sh)
