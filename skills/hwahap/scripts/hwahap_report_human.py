...
def human_sections(view, summary, css, label, counts, metrics, metrics_html,
    ...
    return (
        ...
        '<h2>오케스트레이션 절차 편차와 재발 방지</h2><p class="section-intro">각 절차 편차의 절차 영향, '
        f'발생 원인, 재발 방지, 예방 효과의 한계를 기록하며 구현 결과나 승인 범위의 변경과 분리합니다.</p><div class="change-grid">{deviations}</div>'
