...
REPORT_TAGS = frozenset(("a", "article", "body", "br", "caption", "dd", "details", "div", "dl", "dt", "footer", "h1", "h2", "h3", "head", "header", "html", "li", "main", "meta", "nav", "ol", "p", "section", "small", "span", "strong", "style", "summary", "table", "tbody", "td", "th", "thead", "time", "title", "tr", "ul"))
REPORT_ATTRS = frozenset(("aria-label", "aria-live", "charset", "class", "colspan", "content", "href", "id", "lang", "name", "scope"))
REPORT_TEXT_BOUNDARIES = frozenset(("a", "article", "body", "br", "caption", "dd", "details", "div", "dl", "dt", "footer", "h1", "h2", "h3", "head", "header", "html", "li", "main", "nav", "ol", "p", "section", "strong", "summary", "table", "tbody", "td", "th", "thead", "time", "title", "tr", "ul"))
...
STYLE_BLOCK = """<style>
:root{color-scheme:light dark;--bg:#f8fafd;--surface:#fff;--surface-warm:#e8f0fe;--fg:#202124;--fg-2:#3c4043;--muted:#5f6368;--meta:#1a73e8;--border:#dadce0;--border-soft:#edf0f2;--accent:#1a73e8;--accent-on:#fff;--accent-hover:color-mix(in oklab,var(--accent),black 8%);--accent-active:color-mix(in oklab,var(--accent),black 14%);--success:#188038;--success-surface:#e6f4ea;--success-on:#0d652d;--warn:#f9ab00;--warn-surface:#fef7e0;--warn-on:#5f4500;--danger:#d93025;--danger-surface:#fce8e6;--danger-on:#a50e0e;--font-display:"Google Sans","Noto Sans KR",Roboto,Arial,sans-serif;--font-body:Roboto,"Noto Sans KR",Arial,sans-serif;--font-mono:"Roboto Mono","SFMono-Regular",ui-monospace,Menlo,monospace;--text-xs:12px;--text-sm:14px;--text-base:16px;--text-lg:18px;--text-xl:24px;--text-2xl:32px;--text-3xl:48px;--text-4xl:64px;--leading-body:1.5;--leading-tight:1.12;--tracking-display:0;--space-1:4px;--space-2:8px;--space-3:12px;--space-4:16px;--space-5:20px;--space-6:24px;--space-8:32px;--space-12:48px;--section-y-desktop:96px;--section-y-tablet:68px;--section-y-phone:48px;--radius-sm:4px;--radius-md:12px;--radius-lg:24px;--radius-pill:9999px;--elev-flat:none;--elev-ring:0 0 0 1px var(--border);--elev-raised:0 3px 8px rgba(60,64,67,.18);--focus-ring:0 0 0 4px rgba(26,115,232,.24);--motion-fast:150ms;--motion-base:250ms;--ease-standard:cubic-bezier(.2,0,0,1);--container-max:1200px;--container-gutter-desktop:36px;--container-gutter-tablet:24px;--container-gutter-phone:16px;--md-sys-color-primary:var(--accent);--md-sys-color-on-primary:var(--accent-on);--md-sys-color-primary-container:var(--surface-warm);--md-sys-color-on-primary-container:var(--fg);--md-sys-color-surface:var(--bg);--md-sys-color-surface-container:var(--surface);--md-sys-color-on-surface:var(--fg);--md-sys-color-outline:var(--border);--md-sys-color-error:var(--danger);--md-sys-typescale-display-large:700 var(--text-4xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-display-medium:700 var(--text-3xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-display-small:700 var(--text-2xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-headline-large:700 var(--text-3xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-headline-medium:700 var(--text-2xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-headline-small:700 var(--text-xl)/var(--leading-tight) var(--font-display);--md-sys-typescale-title-large:700 var(--text-xl)/1.25 var(--font-display);--md-sys-typescale-title-medium:700 var(--text-base)/var(--leading-body) var(--font-body);--md-sys-typescale-title-small:700 var(--text-sm)/var(--leading-body) var(--font-body);--md-sys-typescale-body-large:400 var(--text-base)/var(--leading-body) var(--font-body);--md-sys-typescale-body-medium:400 var(--text-sm)/var(--leading-body) var(--font-body);--md-sys-typescale-body-small:400 var(--text-xs)/var(--leading-body) var(--font-body);--md-sys-typescale-label-large:700 var(--text-sm)/1 var(--font-body);--md-sys-typescale-label-medium:700 var(--text-xs)/1 var(--font-mono);--md-sys-typescale-label-small:700 11px/1 var(--font-mono);--md-sys-shape-corner-extra-small:var(--radius-sm);--md-sys-shape-corner-medium:var(--radius-md);--md-sys-shape-corner-large:var(--radius-lg);--md-sys-shape-corner-full:var(--radius-pill);--md-sys-elevation-level1:var(--elev-raised);--md-sys-motion-standard-effects:var(--motion-fast) var(--ease-standard)}
@media (prefers-color-scheme:dark){:root{--bg:#0f1115;--surface:#171a21;--surface-warm:#1e2a3c;--fg:#f8fafc;--fg-2:#dfe3eb;--muted:#a7adba;--border:#2a2f3a;--border-soft:#242832;--meta:#8ab4f8;--accent:#8ab4f8;--accent-on:#062e6f;--accent-hover:color-mix(in oklab,var(--accent),white 8%);--accent-active:color-mix(in oklab,var(--accent),white 14%);--success:#81c995;--success-surface:#173b24;--success-on:#b7f5c8;--warn:#fdd663;--warn-surface:#453600;--warn-on:#fff1b8;--danger:#f28b82;--danger-surface:#4a1d1a;--danger-on:#ffd7d3;--elev-raised:0 3px 8px rgba(0,0,0,.36);--focus-ring:0 0 0 4px rgba(138,180,248,.3)}}
@media (prefers-contrast:more){:root{--bg:#fff;--surface:#fff;--surface-warm:#d9e8ff;--fg:#000;--fg-2:#161616;--muted:#303030;--border:#404040;--border-soft:#707070;--accent:#004ba0;--accent-on:#fff;--success-on:#06451b;--warn-on:#3d2c00;--danger-on:#7a0000}}
@media (prefers-contrast:more) and (prefers-color-scheme:dark){:root{--bg:#000;--surface:#080808;--surface-warm:#12233b;--fg:#fff;--fg-2:#f2f2f2;--muted:#ddd;--border:#c6c6c6;--border-soft:#888;--accent:#aecbfa;--accent-on:#001d35}}
*,*::before,*::after{box-sizing:border-box}html{overflow-x:hidden;background:var(--bg);scroll-behavior:smooth}body{margin:0;min-height:100vh;background:radial-gradient(circle at 88% 8%,color-mix(in oklab,var(--accent) 16%,transparent),transparent 34%),var(--bg);color:var(--fg);font:var(--md-sys-typescale-body-large);-webkit-font-smoothing:antialiased;overflow-wrap:anywhere}a{color:var(--accent);text-underline-offset:.2em}a:hover{color:var(--accent-hover)}a:active{color:var(--accent-active)}a:focus-visible,summary:focus-visible{outline:none;box-shadow:var(--focus-ring);border-color:var(--accent)}.skip-link{position:fixed;z-index:10;inset-block-start:var(--space-2);inset-inline-start:var(--space-2);display:inline-flex;align-items:center;min-block-size:48px;padding:0 var(--space-4);border-radius:var(--radius-md);background:var(--accent);color:var(--accent-on);transform:translateY(-150%)}.skip-link:focus{transform:translateY(0)}.top-app-bar{position:relative;z-index:2;max-width:var(--container-max);margin:var(--space-4) auto 0;padding:var(--space-3) var(--space-5);display:flex;align-items:center;justify-content:space-between;gap:var(--space-4);background:color-mix(in oklab,var(--surface),transparent 4%);border:1px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--elev-ring)}.app-title{font:700 var(--text-xl)/var(--leading-tight) var(--font-display)}.app-kicker,.eyebrow{color:var(--meta);font:700 var(--text-xs)/1 var(--font-mono);letter-spacing:.1em;text-transform:uppercase}.section-nav{max-width:var(--container-max);margin:var(--space-3) auto;padding:0 var(--container-gutter-desktop);display:flex;gap:var(--space-2);overflow-x:auto;scrollbar-width:thin}.nav-chip{display:inline-flex;align-items:center;justify-content:center;min-block-size:48px;padding:0 var(--space-4);white-space:nowrap;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface);box-shadow:var(--elev-ring);font:700 var(--text-sm)/1 var(--font-body);text-decoration:none;color:var(--fg);transition:background-color var(--motion-fast) var(--ease-standard),border-color var(--motion-fast) var(--ease-standard),color var(--motion-fast) var(--ease-standard),transform var(--motion-fast) var(--ease-standard),box-shadow var(--motion-fast) var(--ease-standard)}.nav-chip:hover{border-color:var(--accent);color:var(--accent);background:var(--surface)}.nav-chip:active{transform:translateY(1px);background:var(--surface-warm)}main{max-width:var(--container-max);margin:auto;padding:0 var(--container-gutter-desktop) var(--section-y-desktop)}main>section,main>.decision-layout,main>.evidence-vault{margin-block:var(--section-y-tablet)}section{scroll-margin-block-start:var(--space-8)}h1,h2,h3,p{margin-top:0}h1,h2,h3{font-family:var(--font-display);line-height:var(--leading-tight);letter-spacing:var(--tracking-display)}h1{margin-bottom:var(--space-4);font-size:clamp(42px,6vw,var(--text-4xl));font-weight:760}h2{margin-bottom:var(--space-4);font-size:clamp(30px,4vw,var(--text-3xl));font-weight:700}h3{margin-bottom:var(--space-3);font-size:var(--text-xl);font-weight:700}.section-intro{max-width:68ch;color:var(--fg-2);font-size:var(--text-lg)}.hero{display:grid;grid-template-columns:minmax(0,1.1fr) minmax(320px,.9fr);gap:var(--space-8);align-items:center;padding-block:var(--space-12)}.hero-copy-block{max-width:680px}.stack>*+*{margin-block-start:var(--space-4)}.hero-copy{max-width:640px;color:var(--fg-2);font-size:var(--text-lg);line-height:1.55}.panel{background:color-mix(in oklab,var(--surface),transparent 4%);border:1px solid var(--border);border-radius:var(--radius-lg);box-shadow:var(--elev-raised);overflow:hidden}.panel-head{display:flex;justify-content:space-between;align-items:center;gap:var(--space-4);padding:var(--space-5);border-bottom:1px solid var(--border-soft)}.status-chip,.label-chip{display:inline-flex;align-items:center;gap:var(--space-2);min-block-size:32px;padding:0 var(--space-3);border-radius:var(--radius-pill);font:700 var(--text-xs)/1 var(--font-mono);letter-spacing:.04em}.status-chip::before{content:"";inline-size:8px;block-size:8px;border-radius:var(--radius-pill);background:currentColor}.status-success{background:var(--success-surface);color:var(--success-on)}.status-warning{background:var(--warn-surface);color:var(--warn-on)}.status-error{background:var(--danger-surface);color:var(--danger-on)}.summary-grid{display:grid;grid-template-columns:1fr 1fr}.metric{min-width:0;padding:var(--space-5);border-right:1px solid var(--border-soft);border-bottom:1px solid var(--border-soft)}.metric:nth-child(2n){border-right:0}.metric:nth-last-child(-n+2){border-bottom:0}.metric-label,.field-label{display:block;margin-bottom:var(--space-1);color:var(--muted);font-size:var(--text-sm)}.metric-value{display:block;font:700 var(--text-xl)/var(--leading-tight) var(--font-display)}.cards,.metrics-grid,.proposal-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(min(100%,260px),1fr));gap:var(--space-4);margin-top:var(--space-6)}.change-grid{display:grid;gap:var(--space-6);margin-top:var(--space-6)}.card,.receipt,.proposal-card,.risk-card{min-width:0;padding:var(--space-5);border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface);box-shadow:var(--elev-ring)}.change-card-header{display:flex;align-items:center;justify-content:space-between;gap:var(--space-4);padding:var(--space-5);border-bottom:1px solid var(--border-soft)}.change-card-header h3{margin:0}.change-card-body{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:var(--space-4);padding:var(--space-5)}.change-field{min-height:148px;padding:var(--space-5);border:1px solid var(--border-soft);border-radius:var(--radius-md);background:var(--surface-warm)}.expected-change{margin:0 var(--space-5) var(--space-5);padding:var(--space-4);border-inline-start:4px solid var(--success);border-radius:var(--radius-sm);background:var(--success-surface);color:var(--success-on)}.proposal-card{border-top:4px solid var(--accent)}.risk-card{border-top:4px solid var(--danger)}.notice{color:var(--muted);font-size:var(--text-sm)}details{border-radius:var(--radius-md)}details>summary{cursor:pointer;display:flex;align-items:center;min-block-size:48px;padding:var(--space-3) var(--space-4);border:1px solid transparent;border-radius:var(--radius-md);color:var(--accent);font:700 var(--text-sm)/1 var(--font-body);transition:background-color var(--motion-fast) var(--ease-standard),border-color var(--motion-fast) var(--ease-standard),box-shadow var(--motion-fast) var(--ease-standard)}details>summary:hover{background:var(--surface-warm)}details>summary:active{background:color-mix(in oklab,var(--surface-warm),var(--accent) 8%)}details[open]>summary{background:var(--surface-warm);border-color:var(--border)}.evidence-vault{border:1px solid var(--border);border-radius:var(--radius-lg);background:var(--surface);box-shadow:var(--elev-raised)}.evidence-vault>summary{padding:var(--space-5);border-radius:var(--radius-lg);font-size:var(--text-lg)}.evidence-content{padding:0 var(--space-5) var(--space-5)}.evidence-content>section{margin-block:var(--space-12)}.empty{color:var(--muted);font-style:italic}ul,ol{padding-inline-start:1.4rem}.timeline{display:grid;gap:var(--space-3)}.timeline li{padding:var(--space-4);border-inline-start:4px solid var(--accent);border-radius:var(--radius-sm);background:var(--surface-warm)}dl{margin:0}dt{margin-top:var(--space-3);color:var(--muted);font:700 var(--text-xs)/1 var(--font-mono)}dd{margin-inline-start:0;min-width:0}.table-wrap{max-width:100%;overflow-x:auto;border:1px solid var(--border);border-radius:var(--radius-md);box-shadow:var(--elev-ring)}table{border-collapse:collapse;width:100%;min-width:700px;background:var(--surface)}caption{padding:var(--space-3);text-align:start;color:var(--fg-2);font:700 var(--text-base)/var(--leading-body) var(--font-display)}td,th{padding:var(--space-3);text-align:start;vertical-align:top;overflow-wrap:anywhere;border-bottom:1px solid var(--border-soft)}th{background:var(--surface-warm);font:700 var(--text-xs)/1 var(--font-mono)}.receipt-list{display:grid;gap:var(--space-4)}.receipt dl{display:grid;grid-template-columns:minmax(8rem,auto) 1fr;gap:var(--space-1) var(--space-3)}.snapshot{font-family:var(--font-mono);font-size:var(--text-xs)}.report-footer{margin-top:var(--section-y-tablet);padding-top:var(--space-6);border-top:1px solid var(--border);color:var(--muted);font-size:var(--text-sm)}
@media (max-width:639px){.top-app-bar{margin:0;border-inline:0;border-radius:0}.section-nav{padding-inline:var(--container-gutter-phone)}main{padding-inline:var(--container-gutter-phone);padding-bottom:var(--section-y-phone)}main>section,main>.decision-layout,main>.evidence-vault{margin-block:var(--section-y-phone)}.hero{grid-template-columns:1fr;padding-block:var(--space-6)}h1{font-size:42px}.summary-grid,.change-card-body,.receipt dl{grid-template-columns:1fr}.metric{border-right:0}.metric:nth-last-child(-n+2){border-bottom:1px solid var(--border-soft)}.metric:last-child{border-bottom:0}.change-field{min-height:0}.change-card-header{align-items:flex-start;flex-direction:column}.evidence-content{padding-inline:var(--space-3)}}
@media (min-width:640px) and (max-width:1023px){.section-nav,main{padding-inline:var(--container-gutter-tablet)}.hero{grid-template-columns:1fr}.change-card-body{grid-template-columns:1fr 1fr}.change-field:last-child{grid-column:1/-1}}
@media (min-width:1024px){.decision-layout{display:grid;grid-template-columns:minmax(0,2fr) minmax(300px,1fr);gap:var(--space-6);align-items:start}.supporting-pane{position:sticky;top:var(--space-4)}}
@media (min-width:1200px){.change-grid{grid-template-columns:1fr}.proposal-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media (min-width:1600px){:root{--container-gutter-desktop:48px}}
@media (prefers-reduced-motion:reduce){html{scroll-behavior:auto}*,*::before,*::after{animation:none!important;transition:none!important}}
@media print{.skip-link,.section-nav{display:none}.top-app-bar{box-shadow:none}.supporting-pane{position:static}.evidence-vault{box-shadow:none;border:none}.evidence-vault>summary{display:none}.evidence-vault>.evidence-content{display:block!important}.table-wrap{overflow:visible;box-shadow:none}body{background:#fff;color:#000}}
</style>"""
META_STATIC = ('<meta charset="utf-8">', '<meta name="viewport" content="width=device-width, initial-scale=1">', '<meta name="color-scheme" content="light dark">', '<meta name="material-design-system" content="Material Design 3 theme">', '<meta name="material-theme-source" content="OpenDesign material fixture">', '<meta name="material-theme-source-commit" content="a554d017c8fa12d8913354ba6cf792d26d0c3b54">', '<meta name="material-spec-snapshot" content="2026-08-29">', '<meta name="hwahap-redaction-policy" content="credentials,authorization,bearer,api-key,private-key,password; bounded">')
...
def render_report(payload: dict, source_digest: str) -> bytes:
    ...
    def card(label: str, value: Any) -> str:
        return f'<article class="card"><h3>{esc(label)}</h3><p>{esc(value)}</p></article>'
    ...
    contract_html = (f'<article class="card"><h3>계약 메타데이터</h3><dl>{contract_meta_html}</dl></article>' +
                     "".join(f"<article class=\"card\"><h3>{esc(CONTRACT_LABELS[key])}</h3>{command_items(contract.get(key)) if key == 'test_commands' else items(contract.get(key))}</article>" for key in CONTRACT_LISTS))
    role_html = "".join(f'<article class="card"><h3>{esc(role)}</h3><p>agent: {esc(info.get("agent"))}</p><p>model: {esc(info.get("model"))}</p><p>effort: {esc(info.get("effort"))}</p><p>Fast: {esc(info.get("fast", info.get("fallback_effort", "unknown")))}</p></article>' for role, info in agents.get("roles", {}).items() if isinstance(info, dict))
    profile_html = "".join(f'<article class="card"><h3>agent profile</h3><p>filename: {esc(name)}</p><p>digest: {esc(digest)}</p></article>' for name, digest in agents.get("profiles", {}).items())
    agents_html = role_html + profile_html or card("상태", "역할 정보 없음")
    unit_html = "".join(f'<article class="card"><h3>{esc(unit.get("unit_id"))}: {esc(unit.get("title"))}</h3><p>상태: {esc(unit.get("status"))}</p><p>writer: {shown(unit.get("writer"))}</p><p>replan_count: {shown(unit.get("replan_count"))}</p><p>허용 경로</p>{items(unit.get("allowed_paths"))}<p>Acceptance receipts</p>{command_items(unit.get("acceptance_commands"))}<p>검토 {len(unit.get("review_history", []))}회 · 개선 {len(unit.get("improvement_history", []))}건</p></article>' for unit in units) or '<p class="empty">기록 없음</p>'
    ...
    final_review_html = f'<p>aggregate status: {esc(reviews.get("final_review", {}).get("status"))}</p>' + (
        '<div class="receipt-list">' + "".join(
            f'<article class="receipt"><p>{esc(attempt.get("model"))} / {esc(attempt.get("effort"))} / {esc(attempt.get("status"))} / {esc(attempt.get("thread_id"))}</p><p>diff_digest: {esc(attempt.get("diff_digest"))}</p><p>evidence: {comma_items(attempt.get("evidence", []))}</p>{snapshot_html(attempt.get("diff_snapshot"))}</article>'
    ...
    scope_rows = "".join(
        f'<article class="card"><h3>{esc(item.get("path"))}: {esc(item.get("verdict"))}</h3>'
        ...
        if isinstance(values, list):
            for item in values:
                ...
                for receipt in item["receipts"]:
                    ...
                    cards.append(f'<article class="receipt"><h3>{esc(item.get("unit_id"))}/{esc(receipt.get("test_id"))}</h3><dl>{fields}</dl></article>')
    ...
    candidate_html = "".join(
        f'<article class="proposal-card tile"><span class="label-chip status-warning">사용자 결정 필요</span>'
    ...
    deferred_html = "".join(
        f'<article class="risk-card tile"><span class="status-chip status-error">아직 확인되지 않음</span>'
    ...
    summary_metrics = (
        f'<article class="outcome-panel panel"><div class="panel-head"><div><span class="eyebrow">Verified outcome</span><h3>완료 근거 요약</h3></div>'
    ...
    human_sections = (
        ...
        f'<div class="supporting-pane"><section><span class="eyebrow">Remaining risk</span><h2>아직 남은 위험</h2>'
        f'<p class="section-intro">완료 판정과 별개로 아직 직접 검증하지 못했거나 새 승인이 필요한 항목 {risk_count}건입니다.</p>'
        f'<div class="cards">{deferred_html}</div></section></div></div>'
        ...
        f'<div class="metrics-grid"><article class="card tile"><h3>검증 수치</h3><dl>{metrics_html}</dl><p>{token_html}</p></article>'
        f'<article class="card tile"><h3>최종 리뷰</h3>{final_review_html}</article></div>'
    ...
    footer = ('<footer class="report-footer"><p>OpenDesign Material fixture의 token·panel·metric·state 구성과 Material 3의 '
              'semantic role·adaptive layout·accessibility 원칙을 결합한 네트워크 독립형 정적 보고서입니다.</p>'
              '<p><a href="https://github.com/nexu-io/open-design/tree/a554d017c8fa12d8913354ba6cf792d26d0c3b54/design-systems/material">'
              'OpenDesign Material source</a> · <a href="https://m3.material.io/">Material Design 3 공식 문서</a></p></footer>')
...
def validate_report_bytes(data: bytes, source_digest: str, payload: dict) -> bool:
    ...
    required_material = (
        '<meta name="material-design-system" content="Material Design 3 theme">',
        '<meta name="material-theme-source" content="OpenDesign material fixture">',
        '<meta name="material-theme-source-commit" content="a554d017c8fa12d8913354ba6cf792d26d0c3b54">',
        "--bg:#f8fafd", "--surface:#fff", "--surface-warm:#e8f0fe", "--fg:#202124",
        "--muted:#5f6368", "--border:#dadce0", "--accent:#1a73e8", "--success:#188038",
        "--font-display", "--text-4xl:64px", "--space-12:48px", "--radius-lg:24px",
        "--elev-raised", "--focus-ring", "--container-max:1200px",
        "--md-sys-color-primary", "--md-sys-color-on-primary", "--md-sys-typescale-display-large",
        "--md-sys-typescale-headline-medium", "--md-sys-typescale-title-large",
        "--md-sys-typescale-body-large", "--md-sys-typescale-label-large",
        "--md-sys-shape-corner-extra-small", "--md-sys-shape-corner-large",
        "--md-sys-elevation-level1", "--md-sys-motion-standard-effects",
        ".hero{display:grid", ".panel{background:", ".panel-head{display:flex",
        ".summary-grid{display:grid", ".change-field{", ".proposal-card{", ".risk-card{",
        ...
        "@media (min-width:1024px)", "@media (min-width:1200px)", "@media (min-width:1600px)",
        ...
        "OpenDesign Material source", "a554d017c8fa12d8913354ba6cf792d26d0c3b54",
    ...
    if any(forbidden in text for forbidden in ("Astryx", "astryx", "ReactDOM", "react-dom", "importmap", '<script')):
