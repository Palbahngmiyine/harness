...
def validate_report_bytes(data: bytes, source_digest: str, payload: dict) -> bool:
    ...
    required_material = (
        ...
        ".hero{display:grid", ".panel{min-width:0;background:", ".panel-head{display:flex",
